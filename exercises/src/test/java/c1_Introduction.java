...
public class c1_Introduction extends IntroductionBase {
    ...
    public void hello_world() {
        ...
        serviceResult = hello_world_service();
        serviceResult.subscribe(x -> assertEquals("Hello World!", x));
    ...
    public void unresponsive_service() {
        ...
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            String result = serviceResult.timeout(Duration.ofSeconds(1L), Mono.just(expectedMessage)).block(); //todo: change this line only
